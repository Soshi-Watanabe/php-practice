...
// Q7 連想配列-1
<?php
$mati = ['東京都' => '新宿区','神奈川県' => '横浜市','千葉県' => '千葉市','埼玉県' => 'さいたま市','栃木県' => '宇都宮市','群馬県' => '前橋市','茨城県' => '水戸市'];
...
foreach ($mati as $kenntyou => $value) {
    if ($kenntyou == '埼玉県') echo $kenntyou . 'の県庁所在地は' . $value . 'です。';
}
?>
// Q9 連想配列-3
<?php
$mati = ['東京都' => '新宿区','神奈川県' => '横浜市','千葉県' => '千葉市','埼玉県' => 'さいたま市','栃木県' => '宇都宮市','群馬県' => '前橋市','茨城県' => '水戸市','北海道' => '札幌市', '沖縄県' => '那覇市'];
foreach ((array) $mati as $kenntyou => $value) {
  if ($kenntyou == '東京都' || $kenntyou == '神奈川県' || $kenntyou == '千葉県' || $kenntyou == '埼玉県' || $kenntyou == '栃木県' || $kenntyou == '群馬県' || $kenntyou == '茨城県' ) {
